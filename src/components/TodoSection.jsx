    ...
    <div className="d-flex  flex-col justify-content-center">
      <ol className="list-group mt-4 w-75 text-center ">
        <h5>{props.title}</h5>
            ...
            {props.tasks.lenght===0?(<p className="text-secondary text-center">No Task Available</p>
            ) : 
            ...
            return (
                <li key={i} 
                className={
                    (i === 0 ? "rounded-top " : "") + "list-group-item  d-flex align-items-center justify-content-between" }>
